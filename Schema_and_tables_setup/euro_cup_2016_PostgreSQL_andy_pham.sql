...
CREATE TABLE  euro_cup_2016.soccer_city (
  ...
  PRIMARY KEY(city_id),
    FOREIGN KEY(country_id)
      REFERENCES euro_cup_2016.soccer_country(country_id)
) ;
...
CREATE TABLE  euro_cup_2016.soccer_venue (
  ...
  PRIMARY KEY(venue_id),
    FOREIGN KEY(city_id)
      REFERENCES euro_cup_2016.soccer_city(city_id)
);
...
CREATE TABLE  euro_cup_2016.player_mast (
  ...
  CONSTRAINT playerMast_posiToPlay_soccerCountry_fk
    FOREIGN KEY(posi_to_play)
      REFERENCES euro_cup_2016.playing_position(position_id)
      ON DELETE CASCADE
);
...
CREATE TABLE  euro_cup_2016.match_mast (
  ...
  CONSTRAINT matchMast_matchNo_soccerVenue_fk
    FOREIGN KEY(venue_id)
      REFERENCES euro_cup_2016.soccer_venue(venue_id)
      ON DELETE CASCADE,
  CONSTRAINT matchMast_refereeId_refereeMast_fk
    FOREIGN KEY(referee_id)
      REFERENCES euro_cup_2016.referee_mast(referee_id)
      ON DELETE CASCADE,
  CONSTRAINT matchMast_plrOfMatch_playerMast_fk
    FOREIGN KEY(plr_of_match)
      REFERENCES euro_cup_2016.player_mast(player_id)
      ON DELETE CASCADE
);
...
CREATE TABLE  euro_cup_2016.match_details (
  ...
  player_gk NUMERIC,
    FOREIGN KEY(ass_ref)
      REFERENCES euro_cup_2016.asst_referee_mast(ass_ref_id),
...
CREATE TABLE  euro_cup_2016.goal_details (
  ...
  CONSTRAINT goalDetails_matchNo_matchMast_fk
    FOREIGN KEY(match_no)
      REFERENCES euro_cup_2016.match_mast(match_no)
      ON DELETE CASCADE,
...
CREATE TABLE  euro_cup_2016.team_coaches (
  ...
  CONSTRAINT teamCoaches_coachId_soccerCountry_fk
    FOREIGN KEY(coach_id)
      REFERENCES euro_cup_2016.coach_mast(coach_id)
      ON DELETE CASCADE
);
...
CREATE TABLE  euro_cup_2016.penalty_gk (
  ...
  team_id NUMERIC,
  player_gk NUMERIC,
  CONSTRAINT penaltyGk_matchNo_soccerCountry_fk
    FOREIGN KEY(match_no)
      REFERENCES euro_cup_2016.match_mast(match_no)
      ON DELETE CASCADE,
