/* Question 12: Write a SQL query that returns the total 
number of goals scored by each position on each country's team. 
...
JOIN euro_cup_2016.player_mast AS p
	ON g.player_id= p.player_id
JOIN euro_cup_2016.soccer_country AS s
